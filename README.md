# multi-v2ray
V2ray/Xray Secuencia de comandos de administración de múltiples usuarios, administración de estilo asistente [nuevo | eliminar | modificar] protocolo de transmisión  
...
## 特色
- [x] Admite la gestión de Xray, v2ray y xray son independientes entre sí, con diferentes comandos(v2ray/xray)Ingrese a una gestión central diferente
- [x] Llame a la api oficial de v2ray para obtener estadísticas de tráfico
- [x] **Gestión multiusuario, multipuerto **, la gestión de protocolos de transmisión mixta ya no es un sueño
...
## Instalar comando
```
source <(curl -sL http://v2ray.admplus.tk) --zh
```

## Comando de actualización (mantener actualizado el archivo de configuración)
```
source <(curl -sL http://v2ray.admplus.tk) -k
```
##### Install Mod
```
...
```
source <(curl -sL http://v2ray.admplus.tk) --remove
```
